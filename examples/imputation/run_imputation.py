...
def get_dataset(dataset_name: str, p_fault=0., p_noise=0.):
    ...
    if dataset_name.startswith('re'):
        return RealEstate(impute_nans=True, small=dataset_name[3:] == 'small', max_nodes=5000)
...
def run_experiment(args):
    ...
    ########################################
    tsl.logger.info("create logdir and save configuration")
    ...
    # logging options                      #
    ########################################
    tsl.logger.info("logging options")
...
if __name__ == '__main__':
    ...
    exp = TslExperiment(run_fn=run_experiment, parser=parser, debug=True)
    exp.run()
